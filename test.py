...
file_path = current_dir + "/company_result/company_200k_up.csv"                     #! Chagne File name Depends on the company list
...
folder_list = ['200k-up']                           #! always make more capacity then expectation.
